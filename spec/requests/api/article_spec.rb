...
describe '/api/articles', type: :request do
  ...
  describe "お気に入り登録 POST /:id/favorite" do
    let!(:source_item) {
      FactoryBot.create(:article, user:)
    }
  ...
  describe "お気に入り解除 DELETE /:id/favorite" do
    let!(:source_item) {
      FactoryBot.create(:article, user:)
    }
  ...
  describe 'コメント一覧 GET /:id/comments' do
  ...
  describe 'コメント登録 POST /:id/comments' do
    let!(:source_item) { FactoryBot.create(:article, user:) }
  ...
  describe 'コメント削除 GET /:id/comments/:id' do
    let!(:source_item) { FactoryBot.create(:article, user:) }
